...
class NotesDatabase {
  ...
  Future<Database> get database async {
    ...
    _database = await _initDB('notesDB');
    return _database!;
  }
  ...
  Future _createDB(Database db, int version) async {
    ...
    await db.execute('CREATE TABLE $tableNotes (${NoteFields.id} $idType, ${NoteFields.isImportant} $boolType, ${NoteFields.number} $intType, ${NoteFields.title} $textType, ${NoteFields.description} $textType, ${NoteFields.time} $textType)');
